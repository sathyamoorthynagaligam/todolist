...
import { deleteapi, selectTodo, selectTodoError, todoapi } from "./todoSlice";
...
export default function Todo() {
  ...
  const todotask = useAppSelector(selectTodo);
...
useEffect(()=>{
  ...
  let chuckedTodos = chunkArray(todotask,parseInt(""+(screenWidth/ 300))); 
