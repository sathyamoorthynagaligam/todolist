...
import { editstatusapi } from '../editfield/editslice';
import { useAppDispatch,useAppSelector } from '../../app/hooks';
import { selectInprogress } from '../todo/todoSlice';
import { useEffect } from 'react';
import { inprogressapi } from '../todo/todoSlice';
...
import { selectTodoError } from '../todo/todoSlice';
...
export default function Inprogress() {
  ...
  const inprogresstask = useAppSelector(selectInprogress);
...
useEffect(()=>{
  ...
  let chuckedTodos = chunkArray(inprogresstask,parseInt(""+(screenWidth/ 300))); 
  return (
     <div>
      <Header />
